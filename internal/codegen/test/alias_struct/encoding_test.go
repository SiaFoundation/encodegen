...
var msg = Message{
	...
	AliasImportedTypeField:                  AliasImportedType(testImportedType),
	DoubleAliasImportedTypeField:            DoubleAliasImportedType(AliasImportedType(testImportedType)),
	PointerAliasImportedTypeField:           &aliasTestImportedType,
	AliasImportedTypeSliceField:             AliasImportedTypeSlice([]importedtype.Imported{testImportedType, testImportedType, testImportedType}),
